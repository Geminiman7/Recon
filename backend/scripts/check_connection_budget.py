...
parser.add_argument("--fallback-replicas", type=int, default=1)
parser.add_argument("--fallback-pool", type=int, default=5)
parser.add_argument("--fallback-overflow", type=int, default=2)
...
fallback = args.fallback_replicas * (args.fallback_pool + args.fallback_overflow)
print(f"API={api}, workers={workers}, fallback={fallback}, reserved={args.reserve}, PostgreSQL={args.postgres_max}")
if api + workers + fallback + args.reserve > args.postgres_max:
